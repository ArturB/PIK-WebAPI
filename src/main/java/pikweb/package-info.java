 ...
 *
 *     <li><b>/get/user/points</b>   - zwraca listę w formacie JSON wszystkich punktów zalogowanego użytkownika. </li>
 *
 *     <li><b>/add/user/points?latitude='latit'&amp;logitute='logit'&amp;name='name'</b>   - dodaje do bazy nowy punkt dla zalogowanego użytkownika. </li>
 *
 *     <li><b>/delete/user/points?name='name'</b>   - usuwa z bazy punkt o nazwie 'name', będący własnością zalogowanego użytkownika. </li>
 *
 *     <li><b>get/points</b>   - zwraca listę w formacie JSON wszystkich istniejących w bazie punktów, o ile tylko użytkownik jest zalogowany. </li>
 *
 * </ul>
 *
 * <p>
